...
| `GITHUB_HOST` | Optional URL of the Github Enterprise server e.g github.mycompany.com. Defaults to `github.com`. For GitHub Enterprise Cloud with data residency, set only the host, e.g. `GITHUB_HOST=octocorp.ghe.com`. The API endpoint will be resolved as `https://api.octocorp.ghe.com`. Do not include `https://` in `GITHUB_HOST`.                                                                                                           |
