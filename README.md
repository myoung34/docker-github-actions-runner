...
| ubuntu resolute | `x86_64`,`arm64` | `/\d\.\d{3}\.\d+-ubuntu-resolute/` | [ubuntu-resolute](https://hub.docker.com/r/myoung34/github-runner/tags?page=1&name=ubuntu-resolute) | This is the latest build from resolute (Rebuilt nightly and on master merges). Tags with `-ubuntu-resolute` are included and created on [upstream tags](https://github.com/actions/runner/tags). | |
